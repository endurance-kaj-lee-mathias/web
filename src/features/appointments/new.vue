...
import Slots from "@/features/appointments/components/new/slots.vue";
import Network from "@/features/appointments/components/new/network.vue";
import Base from "@/components/layout/base.vue";
import Header from "@/features/appointments/components/header.vue";

const selected = ref(null as ConnectionId | null);
const slots = ref(false);
...
<template>
    <Base>
        ...
        <Slots v-if="selected" v-model="slots" :id="selected" />
    </Base>
</template>
